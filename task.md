...
### Checklist
- [x] Domain types 정의 (`StrategyTrialRecord`, `SignalPostmortem`, etc.)
- [x] Strategy Trial ID 및 Parameter Hash 구현
- [x] Strategy Trial Store 및 Signal Postmortem Store 구현
- [x] BacktestResult → StrategyTrialRecord 변환기 구현
- [x] Backtest selectedPositions → SignalPostmortem 변환기 구현
- [x] CLI script (`strategy:trial:from-backtest`) 구현
- [x] API routes (GET `/api/strategy/trials`, `/api/strategy/signal-postmortems`) 구현
- [x] UI 최소 연결 (StrategyTrialMemoryPanel, StrategyTrialTable, SignalPostmortemSummary)
- [x] Unit & integration tests 작성
- [x] Docs 작성 (`docs/STRATEGY_TRIAL_MEMORY.md`, `docs/SIGNAL_POSTMORTEM_POLICY.md`)
