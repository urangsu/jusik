...
export async function GET(req: NextRequest) {
  try {
    ...
    if (sourceType !== undefined && !["opendart_filing", "alert_event", "backtest_result", "strategy_trial", "signal_postmortem", "provider_health", "manual_link", "manual_upload"].includes(sourceType)) {
      const envelope: DataEnvelope<null> = {
        value: null,
        status: "error",
        source: "Watchlist Report Store",
