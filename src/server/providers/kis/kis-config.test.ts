...
describe("KIS Config Checks", () => {
  ...
  beforeEach(() => {
    process.env.KIS_APP_KEY = "real_key_for_test";
    process.env.KIS_APP_SECRET = "real_secret_for_test";
  ...
  it("should load configuration from process.env", () => {
    ...
    expect(config.appKey).toBe("real_key_for_test");
    expect(config.appSecret).toBe("real_secret_for_test");
