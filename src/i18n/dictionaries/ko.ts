export const ko = {
  ...
  quietHours: "조용한 시간",
  cooldown: "쿨다운",
  macro_regime_change: "거시 레짐 변경",
  macro_risk_off: "거시 리스크 오프",
  macro_panic: "거시 패닉",
  sentiment_extreme_fear: "극단적 공포",
  sentiment_extreme_greed: "극단적 탐욕",
  regimeRiskOn: "위험 선호",
  regimeSelectiveRiskOn: "선택적 위험 선호",
  regimeNeutral: "중립",
  regimeRiskOff: "위험 회피",
  regimePanic: "패닉",
  regimeOverheated: "과열",
  regimeInsufficientData: "데이터 부족",
};
