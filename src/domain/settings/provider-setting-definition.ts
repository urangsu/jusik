...
export const PROVIDER_SETTING_DEFINITIONS: ProviderSettingDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "KIS_ACCOUNT_NO",
        labelKo: "종합계좌번호 (8자리, 선택)",
        labelEn: "Account Number (8 digits, optional)",
        type: "text",
        required: false,
        secret: false,
      },
      {
        ...
        labelKo: "계좌상품코드 (2자리, 선택)",
        labelEn: "Account Product Code (2 digits, optional)",
        type: "text",
        required: false,
        secret: false,
        defaultValue: "01",
      ...
      {
        key: "KIS_BASE_URL",
        labelKo: "API 기본 URL (자동 결정)",
        labelEn: "API Base URL (Auto-derived)",
        type: "text",
        required: false,
        secret: false,
        defaultValue: "https://openapivts.koreainvestment.com:29443",
      },
    ],
  },
  {
