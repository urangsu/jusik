...
* 시장 데이터 Backfill 정책: [docs/MARKET_BACKFILL.md](docs/MARKET_BACKFILL.md)
* Provider Runtime 정책: [docs/PROVIDER_RUNTIME_POLICY.md](docs/PROVIDER_RUNTIME_POLICY.md)
* 실제 Provider Wiring 점검: [docs/REAL_PROVIDER_WIRING.md](docs/REAL_PROVIDER_WIRING.md)
* AI Provider Dry-run 정책: [docs/AI_PROVIDER_DRY_RUN.md](docs/AI_PROVIDER_DRY_RUN.md)
* Symbol Master 정책: [docs/SYMBOL_MASTER.md](docs/SYMBOL_MASTER.md)
* Surge Detector v2 정책: [docs/SURGE_DETECTOR_V2.md](docs/SURGE_DETECTOR_V2.md)
